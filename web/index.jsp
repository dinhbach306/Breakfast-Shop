...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <c:if test = "${sessionScope.LOGIN_USER.roleID ne 'ADMIN'}">
                        
                        <a class="collapse-item" href="MainController?action=Search" data-toggle="modal" data-target="#userModal">  
                                    Management foods
                        </a>
                        </c:if>
    ...
    <div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">User can not use function?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Come Back Home Page.</div>
                <div class="modal-footer">
