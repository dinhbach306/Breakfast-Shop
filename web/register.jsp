                            ...
                            <form class="user" action="MainController">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        ${requestScope.USER_ERROR.repeate}
                                    </div>
                                </div>
                                <input type="submit" name="action" value="Create" class="btn btn-primary btn-user btn-block">
                                <input class="btn btn-primary btn-user btn-block" type="reset" value="Reset"/>
                                <hr>
                            </form>
                            <hr>
                            <div class="text-center">
